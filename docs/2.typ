...
- *Hyper 爆发槽*：显示在生命值左侧．玩家不再仅仅为了「回血」而擦弹，*擦弹现在的核心收益是积攒 Hyper 槽*．
- *激活方式*：当 Hyper 槽满时，按下 Hyper 键（默认键位为空格）激活．
- *Hyper 状态效果*：
  1. *高度轴机动*：Hyper 激活时，玩家获得极强的垂直机动能力，可以跳跃至极高空，物理上规避地面判定的所有弹幕．
  2. *擦弹续航*：在 Hyper 期间擦弹不再回复生命，而是延长 Hyper 状态的持续时间．
